...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	BOOL bSuccess = CreateProcess(TEXT("..\\DEBUG\\IPCWorker.exe"),
		TEXT("red"), NULL, NULL, FALSE, 0, NULL, NULL, &startupInfoRed, &processInformationRed);
	if (!bSuccess)
	{
	...
	bSuccess = CreateProcess(TEXT("..\\DEBUG\\IPCWorker.exe"),
		TEXT("blue"), NULL, NULL, FALSE, 0, NULL, NULL, &startupInfoBlue, &processInformationBlue);
	if (!bSuccess)
	{
...
HWND InitializeWnd()
{
	...
	HWND hStatic = CreateWindow(TEXT("STATIC"), TEXT(""), WS_CHILD | WS_VISIBLE,
		10, 10, 365, 205, hWnd, (HMENU)BUTTON_CLOSE, wndEx.hInstance, NULL);
