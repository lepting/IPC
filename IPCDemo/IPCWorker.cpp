//// IPCWorker.cpp : Defines the entry point for the console application.
////
//
#include "stdafx.h"
//#include <Windows.h>
...
//	PCOMMUNICATIONOBJECT pCommonObject = NULL;
...
//			pCommonObject = (PCOMMUNICATIONOBJECT)MapViewOfFile(hMapping,
//				FILE_MAP_READ, 0, 0, sizeof(COMMUNICATIONOBJECT));
//
//			if (pCommonObject)
//			{
//				bContinueLoop = !pCommonObject->bExitLoop;
//				hWnd = pCommonObject->hWndClient;
//				lWaitTimeout = pCommonObject->lSleepTimeout;
//				UnmapViewOfFile(pCommonObject);
//				hDc = GetDC(hWnd);
